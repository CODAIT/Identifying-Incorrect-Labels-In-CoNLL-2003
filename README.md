...
the corpus, run the command below.
...
NOTE: [Text Extensions for Pandas](https://github.com/CODAIT/text-extensions-for-pandas) must be installed to run the script.
To install in your Python environment, use the command `pip install text-extensions-for-pandas`.
